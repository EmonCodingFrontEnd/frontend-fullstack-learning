<template>
  <div class='mod-config'>
    ...
    >
      ...
      <el-table-column prop='reason' header-align='center' align='left' label='采购失败原因'></el-table-column>
...
export default {
  ...
  methods: {
    mergeItem() {
      ...
      if (!this.purchaseId) {
        this.$confirm(
          ...
          .then(() => {
            this.$http({
              url: this.$http.adornGatewayUrl('/api/ware/purchase/merge'),
              method: 'post',
    ...
    getUnreceivedPurchase() {
      this.$http({
        url: this.$http.adornGatewayUrl('/api/ware/purchase/unreceive/list'),
        method: 'get',
    ...
    getWares() {
      this.$http({
        url: this.$http.adornGatewayUrl('/api/ware/wareinfo/list'),
        method: 'get',
        params: this.$http.adornParams({
          page: 1,
          limit: 500
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornGatewayUrl('/api/ware/purchasedetail/list'),
        method: 'get',
        params: this.$http.adornParams({
          page: this.pageIndex,
          limit: this.pageSize,
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornGatewayUrl('/api/ware/purchasedetail/delete'),
          method: 'post',
