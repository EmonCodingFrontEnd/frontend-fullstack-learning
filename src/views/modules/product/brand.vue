  ...
  <div class='mod-config'>
    <el-form :inline='true' :model='dataForm' @keyup.enter.native='getDataList()'>
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('product:brand:batchDelete')" type='danger' @click='deleteHandle()'
...
export default {
  ...
  methods: {
    addCatelogSelect() {
      ...
      this.$http({
        url: this.$http.adornGatewayUrl('/api/product/categorybrandrelation/save'),
        method: 'post',
    ...
    deleteCateRelationHandle(id, brandId) {
      this.$http({
        url: this.$http.adornGatewayUrl('/api/product/categorybrandrelation/delete'),
        method: 'post',
    ...
    getCateRelation() {
      this.$http({
        url: this.$http.adornGatewayUrl('/api/product/categorybrandrelation/catelog/list'),
        method: 'get',
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornGatewayUrl('/api/product/brand/list'),
        method: 'get',
        params: this.$http.adornParams({
          'page': this.pageIndex,
          'limit': this.pageSize,
    ...
    updateBrandStatus(data) {
      ...
      this.$http({
        url: this.$http.adornGatewayUrl('/api/product/brand/update/status'),
        method: 'post',
        data: this.$http.adornData({
          'brandId': brandId,
    ...
    deleteHandle(id) {
      ...
      this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
        ...
        this.$http({
          url: this.$http.adornGatewayUrl('/api/product/brand/delete'),
          method: 'post',
